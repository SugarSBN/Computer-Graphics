...
/* package Coordinate-0.1.0.0 */
#ifndef VERSION_Coordinate
#define VERSION_Coordinate "0.1.0.0"
#endif /* VERSION_Coordinate */
#ifndef MIN_VERSION_Coordinate
#define MIN_VERSION_Coordinate(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Coordinate */
...
#define CURRENT_COMPONENT_ID "Coordinate-0.1.0.0-inplace-Coordinate"
