...
/* package Tour-0.1.0.0 */
#ifndef VERSION_Tour
#define VERSION_Tour "0.1.0.0"
#endif /* VERSION_Tour */
#ifndef MIN_VERSION_Tour
#define MIN_VERSION_Tour(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Tour */
...
#define CURRENT_COMPONENT_ID "Tour-0.1.0.0-inplace-Tour"
