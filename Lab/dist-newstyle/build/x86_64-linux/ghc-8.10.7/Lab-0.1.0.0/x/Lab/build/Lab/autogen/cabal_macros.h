...
/* package Lab-0.1.0.0 */
#ifndef VERSION_Lab
#define VERSION_Lab "0.1.0.0"
#endif /* VERSION_Lab */
#ifndef MIN_VERSION_Lab
#define MIN_VERSION_Lab(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Lab */
...
#define CURRENT_COMPONENT_ID "Lab-0.1.0.0-inplace-Lab"
